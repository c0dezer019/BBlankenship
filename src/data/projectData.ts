    ...
    projects: [
      {
        name: 'battleship',
        description:
          'A clone of the classic game, Battleship. It is a turn-based game where each player has their ' +
      ...
      },
      {
        ...
        description:
          'This app was inspired by Quora and StackedOverflow and is a Q&A site purely dedicated to the ' +
      ...
      },
      {
        name: 'stormcaster',
        description:
          'Stormcaster is a WIP weather app that is the first phase to a much larger project. My goal' +
    ...
    upcoming: [
      {
        ...
        description:
          'Project Meteorstorm is the parent project for Stormcaster. The goal of this app is to provide' +
      ...
      },
      {
        ...
        description:
          'Refactoring 404AnswerNotFound into a more modern and faster React app. The project will use' +
          ' Django as a backend with PostgreSQL for the Database.',
      },
      {
        name: 'EnforcerBot',
        description:
          "A Discord bot coded in Python. The bot's main purpose is to monitor user idle times in" +
      ...
      },
      {
        name: 'CitizenBot',
        description:
          'A Discord bot coded in C#. This bot is aimed at the Star Citizen community (an upcoming video' +
